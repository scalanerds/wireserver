...
class UtilsSpec extends FlatSpec with Matchers {
  ...
  "BSON" should "convert" in {
    val bson = new BasicBSONObject("hey", "there")
  ...
  "BSONArray" should "convert" in {
    val bsonArr = Array[BSONObject](
      new BasicBSONObject("hey", "there"),
      new BasicBSONObject("John", "Doe"),
      new BasicBSONObject("Jane", "Doe"))
